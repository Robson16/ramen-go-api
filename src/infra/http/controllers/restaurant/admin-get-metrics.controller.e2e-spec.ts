...
describe('Get admin metrics (e2e)', () => {
  ...
  test('[GET] /admin/metrics - returns entity totals for an admin', async () => {
  ...
  test('[GET] /admin/metrics - rejects a regular user', async () => {
  ...
  test('[GET] /admin/metrics - rejects an unauthenticated user', async () => {
    const response = await request(app.getHttpServer()).get('/admin/metrics')
